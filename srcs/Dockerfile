...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/05/04 11:32:20 by gizawahr          #+#    #+#              #
#    Updated: 2021/07/25 15:38:12 by gizawahr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# ADD USER INFO
LABEL maintaner="gizawahr" \
    mail="<gizawahr@student.42.fr>" \
    name="ft_server"
...
#certificat ssl
RUN		openssl req -x509 -nodes -days 365 -newkey rsa:2048 -subj '/C=FR/ST=75/L=Paris/O=42/CN=gizawahr' -keyout /etc/ssl/private/nginx-selfsigned.key -out /etc/ssl/certs/nginx-selfsigned.crt
